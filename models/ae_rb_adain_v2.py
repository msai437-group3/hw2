...
class AE(nn.Module):
    def __init__(self, latent_dim: int=64) -> None:
        ...
        self.encoder = nn.Sequential(
            ...
            EncoderBlock(16, 32),
            EncoderBlock(32, 64),
            nn.Conv2d(64, latent_dim, 8),
        )

        self.decoder1 = nn.Sequential(
            nn.ConvTranspose2d(latent_dim, 64, 8),
            nn.InstanceNorm2d(64),
            nn.ReLU(inplace=True)
        )
        self.decoder2 = DecoderBlock(64, 32, style_dim=latent_dim)
        self.decoder3 = DecoderBlock(32, 32, style_dim=latent_dim)
